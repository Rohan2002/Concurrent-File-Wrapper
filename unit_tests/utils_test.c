...
void test_append_file_path_to_existing_path()
{
    ...
    {
        printf("Failed Test 1 with output %s\n", new_path_1);
    }
    free(new_path_1);
    ...
    {
        printf("Failed Test 2 with output %s\n", new_path_2);
    }
    free(new_path_2);
}
void test_concat_strings()
{
    ...
    {
        printf("%s", "Passed Concat String Test 1\n");
    }
    else
    {
        printf("Failed Concat String Test 1: %s\n", added_1);
    }
    free(added_1);
    // length 1 > length2
    ...
    {
        printf("%s", "Passed Concat String Test 2\n");
    }
    else
    {
        printf("Failed Concat String Test 2: %s\n", added_2);
    }
    free(added_2);
    // same length.
    ...
    {
        printf("%s", "Passed Concat String Test 3\n");
    }
    else
    {
        printf("Failed Concat String Test 3: %s\n", added_3);
    }
    free(added_3);
    char *added_4 = concat_string("", "", -1, -1);
    if (strcmp(added_4, "") == 0)
    {
        printf("%s", "Passed Concat String Test 4\n");
    }
    else
    {
        printf("Failed Concat String Test 4: %s\n", added_4);
    }
    free(added_4);
    char *added_5 = concat_string("s", "", -1, -1);
    if (strcmp(added_5, "s") == 0)
    {
        printf("%s", "Passed Concat String Test 5\n");
    }
    else
    {
        printf("Failed Concat String Test 5: %s\n", added_5);
    }
    free(added_5);
    char *added_6 = concat_string("", "s", -1, -1);
    if (strcmp(added_6, "s") == 0)
    {
        printf("%s", "Passed Concat String Test 6\n");
    }
    else
    {
        printf("Failed Concat String Test 6: %s\n", added_6);
    }
    free(added_6);
    char *test_one = "lorem";
    char *test_two = "ipsum";
    ...
    {
        printf("%s", "Passed Concat String Test 7\n");
    }
    else
    {
        printf("Failed Concat String Test 7: %s\n", added_7);
    }
    free(added_7);
}
int main()
